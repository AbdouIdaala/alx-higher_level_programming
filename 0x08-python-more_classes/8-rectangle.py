...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        """Compare rectangles based on the area

        Args:
            rect_1 (int): instance of the Rectangle
            rect_2 (int): instance of the Rectangle
        ...
        Returns:
            Instance of Ractangle: The biggest rectangle
        """
